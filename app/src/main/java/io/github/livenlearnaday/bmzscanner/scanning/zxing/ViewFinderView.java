...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private static final float LANDSCAPE_HEIGHT_RATIO = 5f/8;  //default @ 5f/8
    private static final float LANDSCAPE_WIDTH_HEIGHT_RATIO = 5.6f; //default @ 1.4f; 2.8f is ok for tablet but 5 inch screen is too small
    private static final int MIN_DIMENSION_DIFF = 30; //default @ 50
