...
import io.github.livenlearnaday.bmzscanner.scanning.bulkqr.CameraSpecs;
import io.github.livenlearnaday.bmzscanner.scanning.bulkqr.DemoPreference;
...
public class MainApplication extends Application {
    ...
    protected void attachBaseContext(Context base) {
        ...
        if( address == null) {
            Timber.i("Not reporting errors with ACRA");
            return;
        }
